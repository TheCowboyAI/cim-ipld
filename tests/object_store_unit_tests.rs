...
use cim_ipld::object_store::{
    ContentDomain, PartitionStrategy, PullOptions,
    ObjectInfo,
};
use cim_ipld::{ContentType, TypedContent, Cid};
...
fn test_custom_domain_mapping() {
    ...
    strategy.add_domain_mapping(ContentDomain::Research, "custom-research-bucket".to_string());
