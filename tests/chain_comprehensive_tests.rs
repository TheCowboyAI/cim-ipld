...
use cim_ipld::{ContentType, TypedContent, Error};
...
fn test_chain_performance() {
    ...
    println!("Appended {} items in {:?}", item_count, append_duration);
    ...
    println!("Validated {} items in {:?}", item_count, validate_duration);
